...
//analogia: entrar em umv agão para poder entrar na linha do trem
...
s_no * constroi_no (int i){ 
    //  ponteiro novo quada o endereço recebido = pega o endereço do espaço alocado em memoria  aloca um espaço em memória  do tamanho da struct no                                                           
